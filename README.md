...
## 📷 2-2. 데모영상
<details>
<summary>팬덤 등록 및 목록</summary>
<div markdown="1">

![](https://velog.velcdn.com/images/raoni/post/a3230aff-2c1f-401f-b34f-17dc3b72b9db/image.gif)
...
![](https://velog.velcdn.com/images/raoni/post/7460651c-8923-4671-8d15-a95bdec3e037/image.gif)
...
<details>
<summary>피드 댓글 등록 및 삭제</summary>
<div markdown="1">


![](https://velog.velcdn.com/images/raoni/post/5abf6832-4822-4e12-8c8a-fad1e7976eeb/image.gif)
...
<details>
<summary>아이템 검색 및 링크 이동</summary>
<div markdown="1">


![](https://velog.velcdn.com/images/raoni/post/1dd51c05-e510-4123-b29d-8f9779a503f4/image.gif)
...
<details>
<summary>의뢰 작성</summary>
<div markdown="1">

![](https://velog.velcdn.com/images/raoni/post/ced98057-047b-4850-ab73-2cd07fd04b3f/image.gif)
...
<details>
<summary>답변 링크 등록</summary>
<div markdown="1">

![](https://velog.velcdn.com/images/raoni/post/81799d0b-59a2-4890-994a-b4c7d8e2e9f6/image.gif)
...
<details>
<summary>답변 채택</summary>
<div markdown="1">

![](https://velog.velcdn.com/images/raoni/post/fe923947-53aa-4044-9b95-88b5f9638534/image.gif)
...
![](https://velog.velcdn.com/images/raoni/post/e711a58d-d84a-449a-88c0-bc00db00cc9e/image.gif)
...
![](https://velog.velcdn.com/images/raoni/post/fee5fd9f-a5f0-4239-8ce3-2a48916fc95d/image.gif)
...
<details>
<summary>마이페이지 팔로우 및 팔로잉</summary>
<div markdown="1">

![](https://velog.velcdn.com/images/raoni/post/fd47a946-f70b-4f1f-895f-bb16430695e2/image.gif)
...
<details>
<summary>마이페이지 나의 버킷리스트 및 나의 의뢰</summary>
<div markdown="1">

![](https://velog.velcdn.com/images/raoni/post/20202788-8684-43bd-9d45-6f328fd488f9/image.gif)
...
|<img src="https://velog.velcdn.com/images/raoni/post/98ae772d-6860-47bd-a610-6d70222d8625/image.PNG" width="300"/>|<img src="https://velog.velcdn.com/images/raoni/post/542df0f4-e28d-4f19-8b76-ca29ca11eb53/image.PNG" width="300"/>|
...
<details>
<summary>사용기술 & 이슈</summary>
<div markdown="1">

- useRouter, Params 이용하여 작성자 유무 판단
- 답변 채택 유무 map 함수 순회하여 true 값이 하나라도 있다면 채택 옵션 제거
- 이슈:
의뢰 상세페이지 북마크부분이 컴포넌트 상태 끌어올리기가 안됐다.
- 해결:
컴포넌트 props로 주었던 값을 저장했던 setState 값을 같이 주어, 북마크 컴포넌트에서 값을 변경할 때 setState값을 변경하게 바꾸었다.
...
- 팔로우와 팔로잉 유무를 삼항 연산자로 나누었다.
- 이슈:
본인이 아니고 타인의 페이지로 넘어갈 때 피드 목록 부분의 렌더링이 느리다.
- 해결: 
타인 페이지로 넘어갈 때 피드 목록 부분에 렌더링이 되기전에 미리 디폴트로 박스처리를 하여 ux 친화적으로 바꾸는 방법을 찾아보도록 리팩토링을 하고 있다.
...
- Axios 이용하여 token 저장
- useCallback 이용하여 유효성 검사
- 이슈:
사용자가 검색을 하자마자 유효성 검사가 실시간으로 진행되도록 하면 UX적으로 좋을 것 같다.
- 해결:
이 부분도 onBlur 대신 onFocus로 함수를 바꿔 리팩토링을 진행중이다.
